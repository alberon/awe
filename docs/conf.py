# -*- coding: utf-8 -*-
#
# Awe documentation build configuration file, created by
...
project = u'Awe'
copyright = u'2014-%d, Dave James Miller' % date.today().year
...
latex_documents = [
  ('index', 'Awe.tex', u'Awe Documentation',
...
texinfo_documents = [
  ('index', 'Awe', u'Awe Documentation',
   u'Dave James Miller', 'Awe', 'One line description of project.',
   'Miscellaneous'),
]

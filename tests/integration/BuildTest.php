...
class BuildTest extends TestCase
{
    ...
    public function testAddsCrossBrowserPrefixesToCssFilesWithAutoprefixer()
    {
        ...
        $this->build($root = $this->fixtures . '/' . __CLASS__ . '/' . __FUNCTION__, ['autoprefixer' => true]);
    ...
    public function testDoesNotCreateASymlinkIfBowerOptionIsFalse()
    {
        ...
        $this->build($root = $this->fixtures . '/' . __CLASS__ . '/' . __FUNCTION__, ['bower' => false]);
    ...
    public function testDoesNotCreateMapFileIfSourceMapsAreDisabled()
    {
        ...
        $this->build($root = $this->fixtures . '/' . __CLASS__ . '/' . __FUNCTION__, ['sourcemaps' => false]);
    ...
    public function testCreatesSourceMapsForCoffeescript()
    {
        ...
        $this->build($root = $this->fixtures . '/' . __CLASS__ . '/' . __FUNCTION__, ['sourcemaps' => true]);
    ...
    public function testCreatesSourceMapsForAutoprefixedCss()
    {
        ...
        $this->build($root = $this->fixtures . '/' . __CLASS__ . '/' . __FUNCTION__, ['sourcemaps' => true, 'autoprefixer' => true]);
